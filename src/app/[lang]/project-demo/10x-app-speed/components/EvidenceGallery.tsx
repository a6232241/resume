...
export default function EvidenceGallery({ videos, screenshots, references }: EvidenceGalleryProps) {
  ...
  const [selectedScreenshotIndex, setSelectedScreenshotIndex] = useState<number | null>(null); // Changed state variable
  ...
  useEffect(() => {
    // Corrected from useState to useEffect
  ...
  }, [selectedScreenshotIndex, screenshots.length]); // Added dependencies
